...
export class Init1777600056833 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "usuarios" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nombre_usuario" character varying NOT NULL, "correo_electronico" character varying NOT NULL, "contrasena" character varying NOT NULL, "rol" "public"."usuarios_rol_enum" NOT NULL DEFAULT 'user', "esta_verificado" boolean NOT NULL DEFAULT false, "foto" character varying, CONSTRAINT "UQ_e871b7157e4b74290df9baa9c93" UNIQUE ("correo_electronico"), CONSTRAINT "PK_d7281c63c176e152e4c531594a8" PRIMARY KEY ("id"))`);
