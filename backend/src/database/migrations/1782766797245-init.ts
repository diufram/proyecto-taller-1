...
export class Init1782766797245 implements MigrationInterface {
    name = 'Init1782766797245'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."soluciones_estado_enum" AS ENUM('Pendiente', 'En revisión', 'Revisado')`);
        ...
        await queryRunner.query(`CREATE TABLE "soluciones" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "respuesta" text NOT NULL, "estado" "public"."soluciones_estado_enum" NOT NULL, "lenguaje_programacion" "public"."soluciones_lenguaje_programacion_enum" NOT NULL, "resultado_validacion" boolean NOT NULL DEFAULT false, "puntaje_total" integer NOT NULL DEFAULT '0', "confianza_ia" double precision, "justificacion_ia" text, "criterios_evaluacion" jsonb, "problemaId" integer, "usuarioId" integer, CONSTRAINT "PK_f0f37e6a7ad8e96ffe202ca3758" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."problemas_dificultad_enum" AS ENUM('Facil', 'Medio', 'Dificil')`);
        await queryRunner.query(`CREATE TABLE "problemas" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "titulo" character varying NOT NULL, "dificultad" "public"."problemas_dificultad_enum" NOT NULL, "formato_entrada" text NOT NULL, "formato_salida" text NOT NULL, "ejemplo_entrada" text NOT NULL, "ejemplo_salida" text NOT NULL, "competenciaId" integer, CONSTRAINT "PK_3533a0bf7b5deabc98763101348" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."competencias_tipo_enum" AS ENUM('Individual')`);
        await queryRunner.query(`CREATE TABLE "competencias" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nombre" character varying NOT NULL, "fecha_inicio" TIMESTAMP NOT NULL, "fecha_fin" TIMESTAMP NOT NULL, "nivel_dificultad" "public"."competencias_nivel_dificultad_enum" NOT NULL, "estado" "public"."competencias_estado_enum" NOT NULL, "tipo" "public"."competencias_tipo_enum" NOT NULL DEFAULT 'Individual', "max_participantes" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_5200c17b2042a1db2e495f3af37" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."usuarios_rol_enum" AS ENUM('estudiante', 'admin')`);
        await queryRunner.query(`CREATE TABLE "usuarios" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "correo_electronico" character varying NOT NULL, "contrasena" character varying NOT NULL, "rol" "public"."usuarios_rol_enum" NOT NULL DEFAULT 'estudiante', "foto" character varying, "puntos_totales" integer NOT NULL DEFAULT '0', "posicion_global" integer, CONSTRAINT "UQ_e871b7157e4b74290df9baa9c93" UNIQUE ("correo_electronico"), CONSTRAINT "PK_d7281c63c176e152e4c531594a8" PRIMARY KEY ("id"))`);
